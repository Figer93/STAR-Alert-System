"""Initial schema — sources, alerts, rules, notification_logs
...
# Named enum types (PostgreSQL only; SQLite treats them as VARCHAR)
...
def downgrade() -> None:
    ...
    bind = op.get_bind()
    rule_severity_enum.drop(bind, checkfirst=True)
